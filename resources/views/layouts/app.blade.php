...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="{{ asset('tamplate/assets/images/favicon.png') }}"
    />
    
    <!-- Custom CSS -->
    <link href="{{ asset('tamplate/dist/css/style.min.css') }}" rel="stylesheet" />
  ...
  <body>
              ...
              <div class="card blog-widget w-100">
                <div class="card-body">
                  <div class="blog-image">
                    <img
                      src="{{ asset('tamplate/assets/images/background/img5.jpg') }}"
                      alt="img"
          ...
          <div class="row">
            ...
            <div class="col-lg-4 d-flex align-items-stretch">
              <div class="card w-100">
                <img
                  class="rounded-top"
                  src="{{ asset('tamplate/assets/images/background/weatherbg.jpg') }}"
                  alt="Card image cap"
            ...
            <div class="col-lg-5 col-xl-4">
              ...
              <div class="card">
                <img
                  ...
                  src="{{ asset('tamplate/assets/images/background/profile-bg.jpg') }}"
                  alt="Card image cap"
                />
                <div class="card-body little-profile text-center">
                  <div class="pro-img">
                    <img
                      src="{{ asset('tamplate/assets/images/users/4.jpg') }}"
                      alt="user"
                ...
                <div class="message-box contact-box position-relative">
                  <div class="message-widget contact-widget position-relative">
                    ...
                    <a href="#" class="p-3 d-flex align-items-start rounded-3">
                      ...
                      >
                        <img
                          src="{{ asset('tamplate/assets/images/users/1.jpg') }}"
                          alt="user"
                    ...
                    <a href="#" class="p-3 d-flex align-items-start rounded-3">
                      ...
                      >
                        <img
                          src="{{ asset('tamplate/assets/images/users/2.jpg') }}"
                          alt="user"
                          class="rounded-circle w-100"
                        />
                        <span
                    ...
                    <a href="#" class="p-3 d-flex align-items-start rounded-3">
                      ...
                      >
                        <img
                          src="{{ asset('tamplate/assets/images/users/6.jpg') }}"
                          alt="user"
                          class="rounded-circle w-100"
                        />
                        <span
                    ...
                    <a href="#" class="p-3 d-flex align-items-start rounded-3">
                      ...
                      >
                        <img
                          src="{{ asset('tamplate/assets/images/users/5.jpg') }}"
                          alt="user"
                          class="rounded-circle w-100"
                        />
                        <span
                    ...
                    <div class="card-body">
                      <div class="profiletimeline position-relative">
                            ...
                            <div>
                              ...
                              <div class="row">
                                <div class="col-lg-3 col-md-6 mb-3">
                                  <img
                                    src="{{ asset('tamplate/assets/images/big/img1.jpg') }}"
                                    alt="user"
                                ...
                                <div class="col-lg-3 col-md-6 mb-3">
                                  <img
                                    src="{{ asset('tamplate/assets/images/big/img2.jpg') }}"
                                    alt="user"
                                    class="img-fluid rounded-3"
                                  />
                                </div>
                                <div class="col-lg-3 col-md-6 mb-3">
                                  <img
                                    src="{{ asset('tamplate/assets/images/big/img3.jpg') }}"
                                    alt="user"
                                    class="img-fluid rounded-3"
                                  />
                                </div>
                                <div class="col-lg-3 col-md-6 mb-3">
                                  <img
                                    src="{{ asset('tamplate/assets/images/big/img4.jpg') }}"
                                    alt="user"
                                    class="img-fluid rounded-3"
                                  />
                                </div>
                        ...
                        <div class="sl-item my-4 border-top pt-4">
                          <div class="sl-left float-left me-3">
                            <img
                              src="{{ asset('tamplate/assets/images/users/3.jpg') }}"
                              alt="user"
                              class="rounded-circle"
                            />
                          </div>
              ...
              <li>
                <div class="message-center chat-scroll position-relative">
                  ...
                  >
                    <span class="user-img position-relative d-inline-block">
                      <img
                        src="{{ asset('tamplate/assets/images/users/7.jpg') }}"
                        alt="user"
                        class="rounded-circle w-100"
                      />
                      <span
                  ...
                  >
                    <span class="user-img position-relative d-inline-block">
                      <img
                        src="{{ asset('tamplate/assets/images/users/8.jpg') }}"
                        alt="user"
                        class="rounded-circle w-100"
                      />
                      <span
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{ asset('tamplate/dist/libs/jquery/dist/jquery.min.js') }}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{ asset('tamplate/dist/libs/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
    <!-- apps -->
    <script src="{{ asset('tamplate/dist/js/app.min.js') }}"></script>
    <script src="{{ asset('tamplate/dist/js/app.init.dark.js') }}"></script>
    <script src="{{ asset('tamplate/dist/js/app-style-switcher.js') }}"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{ asset('tamplate/dist/libs/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.js') }}"></script>
    <script src="{{ asset('tamplate/dist/libs/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('tamplate/dist/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('tamplate/dist/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('tamplate/dist/js/feather.min.js') }}"></script>
    <script src="{{ asset('tamplate/dist/js/custom.min.js') }}"></script>
    <!--This page JavaScript -->
    <script src="{{ asset('tamplate/dist/libs/apexcharts/dist/apexcharts.min.js') }}"></script>
    <!-- Chart JS -->
    <script src="{{ asset('tamplate/dist/js/pages/dashboards/dashboard1.js') }}"></script>
  </body>
</html>
