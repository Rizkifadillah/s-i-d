<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
      ...
      <div
        ...
        style="
          background: url({{ asset('tamplate/assets/images/background/user-info.jpg') }})
            no-repeat;
        "
      >
        <!-- User profile image -->
        <div class="profile-img">
          <img
            src="{{ asset('tamplate/assets/images/users/profile.png') }}"
            alt="user"
            class="w-100"
          />
        </div>
      ...
      <nav class="sidebar-nav">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a
              class="sidebar-link waves-effect waves-dark sidebar-link"
              href="{{ asset('tamplate/../Documentation/document.html') }}"
              aria-expanded="false"
